...
ADMIN_WHATSAPP_NUMBER="082126803897"
...
echo "╰━━━┻╯╱╰┻╯╱╰━┻━━━━╯"
echo -e "\033[0m"
echo -e "${RED}𝗢𝗪𝗡𝗘𝗥${RESET}${GREEN}𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥${RESET}"
echo -e "\033[32mWHATSAPP DANZZY : 082126803897\033[0m"
echo -e "\033[31mTELEGRAM : t.me/elkalah123\033[0m"
echo -e "${RED} © 𝐛𝐲-𝐝𝐚𝐧𝐳𝐳𝐲"
echo ""
...
case "$OPTION" in
    1)
        ...
        GITHUB_TOKEN="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"

        # Clone repositori menggunakan token
        REPO_URL="https://github.com/danzzy1we/danzzy"
...
;;
     7)
# Default URL gambar
DEFAULT_URL="https://files.catbox.moe/kr8brg.jpg"
